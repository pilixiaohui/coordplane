...
- Owner已批准统一参与者框架(v0.2-delta)需求范围对应的重基线：Budgeted maintained production SLOC目标/软阈值/发布阈值为`20,000 / 21,000 / 22,000`；tests为`21,000 / 22,000 / 23,300`；build/test infrastructure仍为`250 / 400 / 600`；三类合计为`41,250 / 43,400 / 45,900`。总量合格不能覆盖production超限。
...
- Budgeted maintained production/tests/infra/total分别不超过`22,000 / 23,300 / 600 / 45,900`，质量blocker清零；没有为省LOC弱化测试或关键恢复合同。
