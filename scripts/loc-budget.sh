...
failure=false
[ "$production" -le 25000 ] || failure=true; [ "$frontend" -le 3000 ] || failure=true
[ "$tests" -le 27000 ] || failure=true; [ "$infra" -le 700 ] || failure=true; [ "$total" -le 52700 ] || failure=true; [ "$generated_total" -le 3000 ] || failure=true
...
awk -F'|' \
  ...
  END {
    ...
    printf "  \"thresholds\": {\"production\":25000,\"tests\":27000,\"infra\":700,\"total\":52700,\"frontend\":3000,\"generated_review\":3000},\n"
    printf "  \"envelopes\": {\"production\":{\"target\":24000,\"soft\":24500,\"review\":25000},\"tests\":{\"target\":25500,\"soft\":26200,\"review\":27000},\"infra\":{\"target\":250,\"soft\":500,\"review\":700},\"total\":{\"target\":49750,\"soft\":51200,\"review\":52700},\"frontend\":{\"target\":2000,\"soft\":2500,\"review\":3000}},\n"
...
echo "loc-budget: $result production=$production tests=$tests infra=$infra total=$total frontend=$frontend (report: $output)" >&2
